    ...
    <div className="flex flex-col items-center p-8 rounded grow max-h-full">
      ...
      >
        ...
        {messages.length > 0 ? (
          ...
          <Heading
            ...
            textAlign={"center"}
          >
            Ask me anything about PowerQuery{" "}
            <Link href="https://powerquery.io/" color={"blue.200"}>
              documentation!
            </Link>
          </Heading>
        )}
      ...
      <InputGroup size="md" alignItems={"center"}>
        <AutoResizeTextarea
          ...
          maxRows={5}
          marginRight={"56px"}
          placeholder="What does Csv.Document() function do?"
          textColor={"white"}
      ...
      {messages.length === 0 ? (
        <footer className="flex justify-center absolute bottom-8">
          <a
            href="https://github.com/Hugoberry/chat-powerquery-io"
            target="_blank"
